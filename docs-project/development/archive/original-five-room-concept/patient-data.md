# triageRush — v1 Original Concept — Archived Patient Data Contract

> **ARCHIVED:** This patient-data contract describes the original v1 routing
> model. It is retained for history and is not the current specification. See
...
**Former owner:** v1 patient-data semantics, authoring, and validation
