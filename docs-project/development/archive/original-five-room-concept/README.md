# triageRush — v1 Original Concept — Archived Single Source of Truth

> **ARCHIVED:** This document set describes the original v1 concept. It is
> retained as project history and must not be treated as the current
> specification. See the [active Single Source of Truth](../../singleSourceOfTruth/README.md).

**Last reviewed:** 2026-07-25 15:24 PDT
**Status:** Archived v1 original-concept documentation
