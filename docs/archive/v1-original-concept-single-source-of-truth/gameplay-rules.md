# triageRush — v1 Original Concept — Archived Gameplay Rules

> **ARCHIVED:** These are the gameplay rules for the original v1 concept.
> They are not the current specification. See the
> [active Single Source of Truth](../../singleSourceOfTruth/README.md).

**Last reviewed:** 2026-07-25 15:24 PDT
**Status:** Archived v1 original-concept rules
**Former owner:** v1 gameplay behavior and clinical routing
