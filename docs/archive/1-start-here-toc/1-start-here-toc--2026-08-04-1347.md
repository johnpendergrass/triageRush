...
**Latest change:** Incorporated the approved terminal shift navigation: an
active GAME can be quit to HOME or stopped to SHIFT REVIEW, with no resumable
HOME state and no direct return from review to GAME.
