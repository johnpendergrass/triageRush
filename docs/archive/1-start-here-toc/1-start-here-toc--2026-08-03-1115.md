...
**Changes from the previous version:** Updated the current AI handoff link
after the self-contained mobile-game rebuild.
...
5. [Development history](2-dev-history.md) explains how the present direction
   was reached.
6. The current
   [AI handoff](99-ai-handoff--2026-08-02-2010.md) records tactical
