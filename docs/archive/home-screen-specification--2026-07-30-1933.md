...
**Current version:** 2026-07-30 19:33 PDT
...
`HOME-open-doors 852x1515.png` is the permanent `852×1515` RGB background. It
...
|---|---|---:|---:|
| New shift | `inset-start-shift-at-319,357.png` | `514×232` | `319,447` |
| Resumable shift | `inset-resume-shift-at-319,357.png` | `473×267` | `319,447` |
| Shift in progress | No inset | — | — |

The coordinates in the inset filenames are obsolete. The authoritative
position for both is `X 319, Y 447`.
...
`HOME-start-shift.png` and `HOME-resume-shift.png` are retained references and
are not runtime backgrounds.
...
It renders the production background and boombox, exposes temporary X/Y/scale
design controls, streams Classical KING through POWER, pauses/resumes through
MUSIC, and treats UI as a visual placeholder. The positioning gadget is not
part of the production HOME screen.
