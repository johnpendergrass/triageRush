...
> **Superseded 2026-08-01:** Schema 2.2 is now canonical. The temporary 2.1
> review directory and migration script referenced below were intentionally
> removed during consolidation. See `patient-data/schema/patient-schema-notes.md`
> and `patient-data/schema/patient-schema-template.json` for the current contract.
